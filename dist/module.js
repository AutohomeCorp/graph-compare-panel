...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__time_shift_util__ = __webpack_require__(40);
...
__WEBPACK_IMPORTED_MODULE_18_grafana_app_core_core__["coreModule"].directive('grafanaCompareGraph', graphDirective);
...
module.directive('graphCompareLegend', function (popoverSrv, $timeout) {
    return {
        link: function (scope, elem) {
