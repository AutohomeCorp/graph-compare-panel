    ...
    return (
      <div className="graph-legend-popover">
        ...
        <ColorPickerPopover
          ...
          onColorSelect={this.props.onColorChange}
        />
      </div>
    )
  }
...
> {
  ...
  render() {
    const leftButtonClass =
      this.state.yaxis === 1 ? 'btn-success' : 'btn-inverse'
    const rightButtonClass =
      this.state.yaxis === 2 ? 'btn-success' : 'btn-inverse'
    ...
    return (
      <div className="p-b-1">
        ...
        <button
          ...
          className={'btn btn-small ' + leftButtonClass}
        >
          Left
        </button>
        <button
          onClick={this.onToggleAxis}
          className={'btn btn-small ' + rightButtonClass}
        >
          Right
        </button>
      </div>
